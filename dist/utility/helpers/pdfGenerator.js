...
const handleTableData = (response) => {
    ...
    const tableTotals = (0, computeTotal_1.computeTotalsForGroupedData)(tableData);
...
function generatePDF(param1) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const tableData = handleTableData(apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.records);
            ...
            const templatePath = path_1.default.join(__dirname, '..', '..', '..', 'template.handlebars');
